...
export const english: Record<string, string> = {
  ...
  此浏览器不支持全屏: 'This browser does not support fullscreen',
  导入: 'Import',
  撤销: 'Undo',
  重做: 'Redo',
  立体: '3D',
  ...
  动作播放时不切换模组: 'No module swap while a motion plays',
  零件展开时不切换模组: 'No module swap while parts are exploded',
  '模组载入中，请稍候': 'The module is loading — one moment',
