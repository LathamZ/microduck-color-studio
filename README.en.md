...
- **Fit the other feet.** The top bar switches the duck between feet and clip-on skates. The roller geometry is only fetched the first time it is asked for, and once it is on, the actions that need a foot flat on the floor leave the menu.
